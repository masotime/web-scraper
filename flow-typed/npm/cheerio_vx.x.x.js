// flow-typed signature: 14f96f6422c13d91d29d2b9c0f1465eb
// flow-typed version: <<STUB>>/cheerio_v1.0.0-rc.10/flow_v0.164.0

declare module 'cheerio' {
  // this is the Cheerio library type definitions
  ...
  declare export interface CheerioStatic extends CheerioSelector {
      // Document References
      // Cheerio https://github.com/cheeriojs/cheerio
      // JQuery http://api.jquery.com
      xml(): string;
  ...
  declare export interface CheerioAPI extends CheerioSelector, CheerioStatic {
  ...
  declare export default CheerioAPI;
}